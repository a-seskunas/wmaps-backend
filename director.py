...
for file_name in grib_files:
	dir_fetch.main(file_name, 10, 60, 150, 245, 'SD_N', 32.7, 242.85, 9, 160, 310, 25, 16, False)
	dir_fetch.main(file_name, 30, 45, 225, 245, 'SD_wind', 32.7, 242.85, 5, 160, 310, 10, 10, True)
	dir_fetch.main(file_name, 10, 45, 280, 340, 'LBI', 40.5, 360-73.7, 10, 80, 210, 15, 12, False)
	dir_fetch.main(file_name, -70, -10, 130, 290, 'SD_S', 32.7, 242.85, 13, 160, 310, 25, 18, False)
