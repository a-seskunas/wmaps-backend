...
##h3_dir_fetch(arg1, lat1, lat2, lon1, lon2, home_name, home_lat, home_lon, days, angle_start, angle_stop, wind_thresh, wave_period, thin_out, hex_size)

start_time = time.time()

##generate an image from the grib file for the North Pacific
for f in grib_files:
	#h3_dir_fetch.main(f, 10, 60, 150, 245, 'SD_N', 32.7, 242.85, 9, 160, 310, 25, 16, False, 3)
	...
	#h3_dir_fetch.main(f, 10, 45, 280, 340, 'LBI', 40.5, 360-73.7, 10, 80, 210, 15, 12, False, 4)
	dir_fetch.main(f, -70, -10, 130, 290, 'SD_S', 32.7, 242.85, 13, 160, 310, 25, 18, False)
	#h3_dir_fetch.main(f, -70, -10, 130, 290, 'SD_S', 32.7, 242.85, 13, 160, 310, 25, 18, False, 5)
